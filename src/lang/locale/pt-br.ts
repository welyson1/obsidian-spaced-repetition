...
export default {
    ...
    NOTE_IN_IGNORED_FOLDER: "Nota foi salva na pasta ignorada (cheque as configurações).",
    ...
    FLASHCARD_EASY_DESC: 'Custumize o rótulo para o botão de "Fácil"',
    FLASHCARD_GOOD_DESC: 'Custumize o rótulo para o botão de "OK"',
